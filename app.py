...
2.  **Criação da História (Intensificada):** Crie uma história absolutamente realista, envolvente, ORIGINAL e densa, em primeira pessoa.
    ...
    * **Extensão e Densidade por Bloco:** A história deve ser dividida em exatamente {num_blocos} blocos. Cada bloco deve ter entre **100 e 200 palavras**, garantindo que o conteúdo seja denso, aprofundado e preencha substancialmente essa extensão, sem diluir a qualidade narrativa. A IA deve se esforçar para atingir o limite superior (2000 palavras) se o conteúdo permitir, mas mantendo a qualidade.
