...
2.  **Criação da História (Intensificada):** Crie uma história absolutamente realista, envolvente, ORIGINAL e densa, em primeira pessoa.
    ...
    * **Extensão e Densidade por Bloco (EM CARACTERES!):** A história deve ser dividida em exatamente {num_blocos} blocos. Cada bloco DEVE ter entre **3000 e 4000 caracteres**, garantindo que o conteúdo seja densíssimo, aprofundado e preencha substancialmente essa extensão. A IA deve se esforçar para atingir o limite superior (2000 caracteres) se o conteúdo e a qualidade narrativa permitirem, não "enchendo linguiça", mas aprofundando o drama e os detalhes.
...
**- Sem Marcadores Internos no Texto: NUNCA inclua marcações como "Ato X:", "(Gatilho Mental: ...)", "(Reviravolta X)", "(Comando Humano: ...)", ou qualquer outra meta-informação dentro do texto da história ou de qualquer outro campo de string.**
...
"""
    ...
    # 1. Cria o modelo de IA (AGORA USANDO O MODELO PRO NOVAMENTE!)
    ...
    try:
        ...
        # DEBUG: Printa os primeiros 500 chars da resposta bruta da IA para o Render logs
